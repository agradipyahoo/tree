...
var TreeItem = exports.TreeItem = function (_SelectableItem) {
    ...
    function TreeItem() {
        ...
        _this2.toggleExpand = function (e) {
            e && e.preventDefault(); // if children is there??
            if (_this2.isOpen()) {
                _this2.setState({ expand: false });
            } else {
                if (_this2.hasChildren()) {
                    var childList = _this2.getChildrenList(); //getChildrenList -->it is deffered,
                    childList.then(function (data) {
                        _this2.setState({ expand: true, children: data });
                    });
                }
            }
        };
    ...
    _createClass(TreeItem, [{
        ...
        value: function componentDidMount() {
            ...
            var selected = selectionManager.isSelected(itemData);
            if (!selected) {
        ...
        value: function isParentSelected() {
            var _props7 = this.props,
                itemData = _props7.itemData,
                selectionManager = _props7.selectionManager;
        ...
        value: function renderContent() {
            ...
            return _react2.default.createElement(
                ContainerTag,
                tagProps,
                _react2.default.createElement(ClickItemContentTag, { expand: this.state.expand, toggleExpand: this.toggleExpand, selectionManager: this.props.selectionManager, onClick: this.selectItem.bind(this), name: itemData.name, hasChild: this.hasChildren(), id: itemData.id, children: this.state.children })
            );
        }
    }]);
...
var SubtreeComponent = exports.SubtreeComponent = function (_Component) {
    ...
    function SubtreeComponent() {
        _classCallCheck(this, SubtreeComponent);

        return _possibleConstructorReturn(this, (SubtreeComponent.__proto__ || Object.getPrototypeOf(SubtreeComponent)).apply(this, arguments));
    }
        ...
        value: function render() {
            ...
            if (this.props.expand) {
                ...
                return _react2.default.createElement(
                    "div",
                    null,
                    _react2.default.createElement(ExpandCollapse, { toggleExpand: this.props.toggleExpand, expand: this.props.expand }),
    ...
    _createClass(Tree, [{
        ...
        value: function render() {
            ...
            var _props8 = this.props,
                _props8$ListItem = _props8.ListItem,
                ListItem = _props8$ListItem === undefined ? TreeItem : _props8$ListItem,
                _props8$showSearch = _props8.showSearch,
                showSearch = _props8$showSearch === undefined ? false : _props8$showSearch;
